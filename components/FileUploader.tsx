    ...
    return (
        <div className="flex flex-col gap-4 items-center max-w-7xl mx-auto">
            ...
            {!uploadInProgress && (<div {...getRootProps()}
                className={`p-10 border-2 border-dashed border-indigo-600 text-indigo-600 mt-10 w-[90%] rounded-lg h-96 flex items-center justify-center ${isFocused || isDragAccept ? "bg-indigo-300" : "indigo-100"}`}
            >
                <input {...getInputProps()} />
